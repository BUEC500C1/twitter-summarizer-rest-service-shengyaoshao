...
def get_all_tweets(account1,number1,filepath,consumer_key, consumer_secret,access_key, access_secret):
        ...
        return fileorder
def googlevision(account1,number1,filepath1, filepath2,consumer_key, consumer_secret,access_key, access_secret):
        filenumber = int(get_all_tweets(account1,number1,filepath1,consumer_key, consumer_secret,access_key, access_secret))
        ...
        while(file_name < filenumber):
                ...
                if (flag == 0):
                        ...
                        draw.text((x11, y11), message, fill=color, font=font)
